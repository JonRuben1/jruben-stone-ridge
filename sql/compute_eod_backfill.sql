-- Backfill variant of compute_eod.sql: same MERGE, but with no lookback
-- window. Scans the entire prices table. Use for one-shot historical loads;
-- the scheduled MERGE in compute_eod.sql stays incremental.
